...
class __TwigTemplate_d1cfe0816063dcc4e7bfe89e1caa6b33 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/january_theme/templates/navigation/menu--primary-menu.html.twig", "/var/www/html/web/themes/contrib/january_theme/templates/navigation/menu--primary-menu.html.twig");
    }
